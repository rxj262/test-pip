(function ($) {
  $(document).ready(function () {
    ...
    if (
      ...
      $("ul.admin-list li").hide();
      $('ul.admin-list li a[href*="/media/add/document"]').parent().show();
      $('ul.admin-list li a[href*="/media/add/image"]').parent().show();
      if ($('ul.admin-list li a[href*="/media/add/private_file"]').length) {
        $('ul.admin-list li a[href*="/media/add/private_file"]')
          .parent()
          .show();
      }
      if ($('ul.admin-list li a[href*="/media/add/hr_document"]').length) {
        $('ul.admin-list li a[href*="/media/add/hr_document"]').parent().show();
      }
    }
    ...
    if ($(".toolbar-menu").length > 0) {
      ...
      */
      ...
      $("a.toolbar-icon-admin-toolbar-tools-extra-linksnode-add+ul li")
        .sort(asc_sort)
        .appendTo("a.toolbar-icon-admin-toolbar-tools-extra-linksnode-add+ul");
...
(function ($, Drupal) {
  ...
  $(document).ready(function () {
    if (window.location.pathname.indexOf("/node/add") !== -1) {
      ...
      $("#edit-actions").addClass("action-big-margin-changer");
