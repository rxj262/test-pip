...
#### BrowserSync in StyleGuide
`npm run watch`
`http://localhost:3000/themes/custom/crew_entrepreneurship/dist/style-guide/section-components.html`

### Generate a new component
`npx -p yo -p generator-mc-d8-theme -c 'yo mc-d8-theme:component "Component Name"'`

### Generate a new behavior
`npx -p yo -p generator-mc-d8-theme -c 'yo mc-d8-theme:js-behavior "search"'`
