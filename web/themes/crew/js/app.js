...
(function ($) {
  ...
  $(window).resize(function(){
    if (drupalSettings.path.baseUrl == '/law/') {
      if ($(window).width() >= 992){
  ...
  if (drupalSettings.path.baseUrl == '/give/') {
  ...
  // console.log(drupalSettings.path.baseUrl);
  if (drupalSettings.path.baseUrl == '/dental/') {
  ...
  if (drupalSettings.path.baseUrl == '/weatherhead/') {
    ...
    $('ul[block="block-crew-weatherhead-main-menu"] a[href$="/alumni-0"]').parent().css("display", "none");
    $('ul[block="block-crew-weatherhead-main-menu"] a[href$="/faculty-staff"]').parent().css("display", "none");
  ...
  // console.log(drupalSettings.path.baseUrl);
  if (drupalSettings.path.baseUrl == '/mstp/') {
    // $('ul[block="block-crew-main-menu"] a[href$="/alumni"]').parent().css("display", "none");
  ...
  if (drupalSettings.path.baseUrl == '/pqhs/') {
  ...
  // console.log(drupalSettings.path.baseUrl);
  if (drupalSettings.path.baseUrl == '/medicine/neurosciences/') {
   // $('ul[block="block-crew-main-menu"] a[href$="/alumni"]').parent().css("display", "none");
    $('ul[block="block-crew-main-menu"] a[href$="/students"]').parent().css("display", "none");
    $('ul[block="block-crew-main-menu"] a[href$="/faculty-staff"]').parent().css("display", "none");
  }
  ...
  // console.log(drupalSettings.path.baseUrl);
  if (drupalSettings.path.baseUrl == '/bme/') {
  ...
  if (drupalSettings.path.baseUrl.startsWith('/studentlife/')) {
  ...
  if (drupalSettings.path.baseUrl.startsWith('/studentlife/academicresources/') || drupalSettings.path.baseUrl.startsWith('/studentlife/accommodatedtesting/') || drupalSettings.path.baseUrl.startsWith('/studentlife/activities/') || drupalSettings.path.baseUrl.startsWith('/studentlife/careercenter/') || drupalSettings.path.baseUrl.startsWith('/studentlife/civicengagement/') || drupalSettings.path.baseUrl.startsWith('/studentlife/conduct/') || drupalSettings.path.baseUrl.startsWith('/studentlife/dean/') || drupalSettings.path.baseUrl.startsWith('/studentlife/disability/') || drupalSettings.path.baseUrl.startsWith('/studentlife/graduate/') || drupalSettings.path.baseUrl.startsWith('/studentlife/greek/') || drupalSettings.path.baseUrl.startsWith('/studentlife/healthcounseling/') || drupalSettings.path.baseUrl.startsWith('/studentlife/multicultural/') || drupalSettings.path.baseUrl.startsWith('/studentlife/residence/') || drupalSettings.path.baseUrl.startsWith('/studentlife/studentcenters/') || drupalSettings.path.baseUrl.startsWith('/studentlife/ugadvisingsupport/') || drupalSettings.path.baseUrl.startsWith('/studentlife/ugadvisingsupport/') || drupalSettings.path.baseUrl.startsWith('/studentlife/ugresearch/')) {
  ...
  if (drupalSettings.path.baseUrl == '/law/' || drupalSettings.path.baseUrl == '/law/') {
  ...
  if (drupalSettings.path.baseUrl == '/lifelonglearning/') {
...
if ($("form.webform-submission-transcript-and-mspe-request-form-add-form").length > 0) {
  ...
  $(document).ready(function () {
    ...
    if (drupalSettings.path.baseUrl == '/umc/') {
...
//     });
    ...
    $(document).ajaxSuccess(function () {
        //addSearchIcon();
        if (drupalSettings.path.baseUrl == '/centerforebp/') {
        resourcesDropdowns();
        resetAjax ++;
          if (resetAjax > 1) {
    ...
    $(document).ajaxSuccess(function () {
      //addSearchIcon();
      if (drupalSettings.path.baseUrl == '/researchprojects/') {
      resourcesDropdowns();
      resetAjax ++;
        if (resetAjax > 1) {
            var filtersEl = $('.view-filters');
    ...
    $(document).ready(function () {
      if (drupalSettings.path.baseUrl == '/research/') {
        coreFacilitiesFocus();
      }
    });
