...
//      kint($_SERVER);exit;
      ...
      $process = new Process(["/mnt/www/html/cwru.prod/docroot/vendor/drush/drush/drush.php", "@self", "sqlq", "SELECT name, mail, status from users_field_data", "--uri=cwru.prod.acquia-sites.com/$uri"]);
    }
